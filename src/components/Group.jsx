...
function Group() {
  return (
    ...
    <div className='relative'>
      <input className='shadow-xl rounded-2xl mb-4 px-20 w-[427px] h-[60px] font-poppins  text-[18px] text-[#3D3D3D]' type="text" placeholder='Search' />
    ...
    <div className='p-5 shadow-xl rounded-2xl'>
      <div className='flex justify-between'>
        <h1 className='font-poppins font-semibold text-[18px]'>Groups Request</h1>
      ...
      <div className='flex items-center justify-between mt-3 border-b pb-2 pt-2 rounded-lg   hover:bg-[rgba(0,0,0,0.05)]  cursor-pointer'>
        ...
        <div>
          ...
          <button className='rounded-md p-1 text-white font-poppins font-semibold text-[20px] bg-color2'>Accept</button>
        </div>
      </div>
      <div className='flex items-center justify-between mt-3 border-b pb-2 pt-2 rounded-lg   hover:bg-[rgba(0,0,0,0.05)]  cursor-pointer'>
        <div>
